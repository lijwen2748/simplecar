...
CPPSOURCES = checker.cpp carsolver.cpp mainsolver.cpp model.cpp utility.cpp state.cpp main.cpp \
	minisat/core/Solver.cc minisat/utils/Options.cc minisat/utils/System.cc
#CSOURCES = aiger.c picosat/picosat.c
#CPPSOURCES = bfschecker.cpp checker.cpp carsolver.cpp mainsolver.cpp model.cpp utility.cpp state.cpp main.cpp \
	glucose/core/Solver.cc glucose/utils/Options.cc glucose/utils/System.cc

OBJS = checker.o carsolver.o mainsolver.o model.o main.o utility.o state.o aiger.o\
